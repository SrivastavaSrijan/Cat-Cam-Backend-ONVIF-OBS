...
from fixed_ptz_cam import FixedPtzCam  # Import our fixed PTZ implementation
    ...
    def initialize_cameras(self, camera_configs):
        ...
        for cam in camera_configs:
            ...
            try:
                ...
                print(f"✅ Initialized camera: {nickname}, {initialized_camera.host}")
...
class ONVIFCameraInstance:
    ...
    def setup_move(self, IP, PORT, USER, PASS):
        ...
        try:
            ...
            self.is_online = True
            print(f"✅ FixedPtzCam initialized: {IP}")
        except Exception as e:
        ...
        try:
            ...
            if profiles and len(profiles) > 0:
                ...
                if not self.is_online:  # Only mark online if FixedPtzCam failed
                    self.is_online = True
                    print(f"✅ ONVIF backup initialized: {IP}")
        except Exception as e:
